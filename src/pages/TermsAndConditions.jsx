...
const TermsAndConditions = () => {
    return (
        <div className="page-container terms-and-conditions-container">
            <Container>
                <div className="page-content">
                    <h1 className="page-title text-center">Terms and Conditions</h1>
                    <div className="description">
                        <p>This website is operated by Bleach Pty Ltd ABN 82 617 078 832, who trade as AnswerSheet (“AnswerSheet”, “we”, “us”, “our”) under the domain name answersheet.au (“the website”).</p>
                        <p>We offer you the service of AnswerSheet on the condition that you agree to the following terms:</p>
                        <h4 className="sub-title">Intellectual Property Rights</h4>
                        ...
                        <h4 className="sub-title">Information Does Not Represent Professional Advice</h4>
                        ...
                        <h4 className="sub-title">Accuracy and Usefulness of Information</h4>
                        ...
                        <h4 className="sub-title">Access</h4>
                        ...
                        <h4 className="sub-title">Variation of These Terms</h4>
                        ...
                        <h4 className="sub-title">No Warranties or Representations</h4>
                        ...
                        <h4 className="sub-title">No Guarantees as to the Service</h4>
                        ...
                        <h4 className="sub-title">Prices and Payments</h4>
                        ...
                        <h4 className="sub-title">Links to Third Party Websites</h4>
                        ...
                        <h4 className="sub-title">Severability</h4>
                        ...
                        <h4 className="sub-title">General</h4>
                        ...
                        <h4 className="sub-title">Reservation of Rights</h4>
                        ...
                        <h4 className="sub-title">Conduct Policy</h4>
                        <p>By using this website, you agree to AnswerSheet’s Conduct Policy below. You must not:</p>
                        <p>(a) use the the website in breach of any applicable laws or regulations;<br/>(b) use the website (or material obtained from the website):</p>
                        <ul>
                        ...
                        <p>(c) use the website to upload, post, transmit or otherwise make available (or attempt to upload, post, transmit or otherwise make available) any material that:</p>
                        <ul>
                        ...
                        <p>(d) interfere with, disrupt, or create an undue burden on AnswerSheet;<br/>(e) use any robot, spider, or other device or process to retrieve, index, or in any way reproduce, modify or circumvent the navigational structure, security or presentation of the website;<br/>(f) use the website with the assistance of any automated scripting tool or software;<br/>(g) frame or mirror any part of the website without our prior written authorization;<br/>(h) use code or other devices containing any reference to the website to direct other persons to any other web page;<br/>(i) except to the extent permitted by law, modify, adapt, sublicense, translate, sell, reverse engineer, decipher, decompile or otherwise disassemble any portion of the website or cause any other person to do so; or<br/>(j) delete any attributions or legal or proprietary notices on the website.</p>
                        <h4 className="sub-title">Terms of Purchase & Refund Policy</h4>
                        ...
                        <h4 className="sub-title ms-3">Terms of Purchase</h4>
                        <div className="ms-3">
                            <ul>
                        ...
                        <h4 className="sub-title ms-3">Refund Policy:</h4>
                        <div className="ms-3">
                            <ul>
